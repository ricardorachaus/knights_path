...
public class Monster : GameObject {
    ...
    func animateMonster () -> SKAction {
        let animate = SKAction.animate(with: [monsterTexture], timePerFrame: 0.1)
